...
function GetData(id, name, email, birthday, phone, CIC, address, rank, sex, cid) {
    ...
    document.getElementById("CICC").value = CIC;
    document.getElementById("address").value = address;
    document.getElementById("rank_").value = rank;
    document.getElementById("classI").value = cid;
    if(sex === 'MEN')
