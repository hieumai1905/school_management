...
<div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="/semesters" class="nav-link active">
                            <span class="nav-icon badge">H</span>
                            <p>[Học kỳ]</p>
                        </a>
                    </li>
                                ...
                                <table id="products" class="table table-bordered table-striped">
                                    ...
                                    <c:forEach items="${semesters}" var="semester">
                                        <tr>
                                            ...
                                            <td>${semester.finishAt}</td>
                                            <td style="text-align: center;" class="option-khoa">
                                                <button class="btn btn-warning btn-sm"
                                                        onclick="GetData('${semester.id}','${semester.semesterName}',
                                                                '${semester.startAt}', '${semester.finishAt}')">Sửa
                                                </button>
                                                |
                                                <button class="btn btn-danger btn-sm"
                                                        onclick="DeleteData('${semester.id}','${semester.semesterName}')">Xóa
                                                </button>
                                            </td>
                                        </tr>
                                    </c:forEach>
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            <h3 class="modal-title">Sửa thông tin học kỳ</h3>
            ...
            <div class="modal-body">
                <form action="/semesters" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="semester-name" class="form-control" id="name"
                               placeholder="Tên học kỳ">
                    </div>
                    <div class="form-group">
                        <label for="start">Năm bắt đầu</label>
                        <input type="number" min="0" default="0" name="start-at" class="form-control" id="start"
                                placeholder="Năm bắt đầu">
                    </div>
                    <div class="form-group">
                        <label for="end">Năm kết thúc</label>
                        <input type="number" min="0" default="0" name="finish-at" class="form-control" id="end"
    ...
    <div id="modalCreate" class="modal">
        ...
        <!-- Modal content -->
        <div class="modal-content">
            <h3 class="modal-title">Tạo mới thông tin học kỳ</h3>
            <div class="close">&times;</div>
            <div class="modal-body">
                <form action="/semesters" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="semester-name" class="form-control" id="tenHocKy"
                               aria-describedby="emailHelp" placeholder="Tên học kỳ">
                    </div>
                    <div class="form-group">
                        <label for="namBatDau">Năm bắt đầu</label>
                        <input type="number" min="0" default="0" name="start-at" class="form-control" id="namBatDau"
                               aria-describedby="emailHelp" placeholder="Năm bắt đầu">
                    </div>
                    <div class="form-group">
                        <label for="namKetThuc">Năm kết thúc</label>
                        <input type="number" min="0" default="0" name="finish-at" class="form-control" id="namKetThuc"
                               aria-describedby="emailHelp" placeholder="Năm kết thúc">
                    </div>
    ...
    <div id="modalDelete" class="modal">
        ...
        <!-- Modal content -->
        <div class="modal-content">
            <h3 class="modal-title">Xóa thông tin học kỳ</h3>
            <div class="close">&times;</div>
            <div class="modal-body">
                <form action="/semesters" method="post">
                    <div class="input-field">
                        Bạn có chắc chắn muốn xóa học kỳ <span id="tenM"></span> ?
                    </div>
                    <input id="semester_id" name="id" type="hidden"/>
