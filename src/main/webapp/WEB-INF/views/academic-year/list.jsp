...
<div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item option-khoa">
                        <a href="/AcademicYears" class="nav-link active">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Danh sách niên khóa</h1>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;" class="option-khoa">
                                                <button class="btn btn-warning btn-sm"
                                                    onclick="GetData('${a.id}','${a.academicYear}')"
                                                >Sửa
                                                </button>
                                                |
                                                <button class="btn btn-danger btn-sm"
                                                        onclick="DeleteData('${a.id}','${a.academicYear}')">Xóa
                                                </button>
                                            </td>
                                        </tr>
                                    </c:forEach>
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            <h3 class="modal-title">Sửa thông tin niên khóa</h3>
            <div class="close">&times;</div>
            <div class="modal-body">
                <form action="/AcademicYears" method="post">
                    <input name="action" value="edit" hidden/>
                    <input name="id" hidden id="id"/>
                    <div class="form-group">
                        <label for="name">Niên khóa</label>
                        <input type="text" name="academic-year" class="form-control" id="name"
    ...
    <div id="modalCreate" class="modal">
        ...
        <!-- Modal content -->
        <div class="modal-content">
            <h3 class="modal-title">Tạo mới thông tin niên khóa</h3>
            <div class="close">&times;</div>
            <div class="modal-body">
                <form action="/AcademicYears" method="post">
                    <input name="action" value="add" hidden/>
                    <div class="form-group">
                        <label for="tenHocKy">Niên khóa</label>
                        <input type="text" name="academic-year" class="form-control" id="tenHocKy"
                               aria-describedby="emailHelp" placeholder="Niên khóa">
                    </div>
    ...
    <div id="modalDelete" class="modal">
        ...
        <!-- Modal content -->
        <div class="modal-content">
            <h3 class="modal-title">Xóa thông tin niên khóa</h3>
            <div class="close">&times;</div>
            <div class="modal-body">
                <form action="/AcademicYears" method="post">
                    <div class="input-field">
                        Bạn có chắc chắn muốn xóa niên khóa <span id="tenM"></span> ?
                    </div>
                    <input id="academic_year_id" name="id" type="hidden"/>
...
<script src="/static/js/academic-year.js"></script>
<!-- jQuery -->
